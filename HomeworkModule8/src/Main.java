...
public class Main {
    public static void main(String[] args) {
        ...
        List<Student> listOfAllStudents = Arrays.asList(
                new Student("Petrov", "Petr", BSU, FACULTY_OF_BIOLOGY, 555, BIOLOGY, 10, HUMAN_ANATOMY, 8, PHYSICAL_EDUCATION, 6),
                ...
                new Student("Ivanova", "Rita", BSU, FACULTY_OF_INTERNATIONAL_RELATIONS, 222, ENGLISH_LANGUAGE, 2, HISTORY, 8, PHYSICAL_EDUCATION, 10),
                new Student("Volotovskaya", "Rita", BSU, FACULTY_OF_INTERNATIONAL_RELATIONS, 222, ENGLISH_LANGUAGE, 3, HISTORY, 9, PHYSICAL_EDUCATION, 10),
        ...
        CalculatingAverageMark.averageMarkForSpecialSubjectInSpecialGroupOnSpecialFaculty(listOfGroups, FACULTY_OF_INTERNATIONAL_RELATIONS, 222, ENGLISH_LANGUAGE);
        CalculatingAverageMark.averageMarkForSpecialSubjectInAllUniversity(listOfFaculties, PHYSICAL_EDUCATION);
    }
}
